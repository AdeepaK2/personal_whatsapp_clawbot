...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  return [
    ...
    "",
    "IMPORTANT: You are acting on behalf of **Adeep** (the owner of this agent).",
    "The user you are replying to is the **Sender**.",
    "Do not confuse yourself with the user. You are Adeep's AI Assistant.",
    "",
    "```json",
